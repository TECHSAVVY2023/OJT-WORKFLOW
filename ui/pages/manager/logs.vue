  ...
  <div class="min-h-full bg-palette-cream/40">
    <header class="bg-palette-white border-b border-palette-olive/15 shadow-sm">
      <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        <h1 class="font-heading text-xl sm:text-2xl lg:text-3xl font-bold text-palette-brown">Activity Logs</h1>
        <p class="mt-1 text-sm text-palette-brown/70 max-w-2xl">
          Recent actions by admin, staff, and manager.
        </p>
      </div>
    </header>
    <div class="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <table class="w-full divide-y divide-palette-olive/20">
          ...
          <tbody class="bg-palette-white divide-y divide-palette-olive/15">
            <tr v-if="filteredLogs.length === 0">
              <td colspan="6" class="px-3 sm:px-4 py-12 sm:py-16 text-center text-palette-brown/80 text-sm font-medium">
                No logs to show.
              </td>
            </tr>
