  ...
  <div class="min-h-full bg-palette-cream/40">
    <header class="bg-palette-white border-b border-palette-olive/15 shadow-sm">
      <div class="px-6 lg:px-8 py-6 sm:py-8">
        <h1 class="font-heading text-2xl sm:text-3xl font-bold text-palette-brown">Categories</h1>
        <p class="mt-1 text-sm text-palette-brown/70">Manage menu categories. Base categories from the menu are read-only; you can add and edit custom categories.</p>
      </div>
    </header>
